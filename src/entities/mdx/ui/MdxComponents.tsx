...
export const mdxComponents = {
    Link: Link,
    h1: (props: any) => <h1 className="my-3 text-2xl font-bold" {...props} />,
    h2: (props: any) => <h2 className="my-2 text-xl font-bold" {...props} />,
    h3: (props: any) => <h3 className="my-2 text-lg font-bold" {...props} />,
    h4: (props: any) => <h4 className="text-md my-1 font-bold" {...props} />,
    h5: (props: any) => <h5 className="my-1 text-sm font-bold" {...props} />,
    h6: (props: any) => <h6 className="my-1 text-xs font-bold" {...props} />,
